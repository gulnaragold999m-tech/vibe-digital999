...
<style>
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  .book::before{content:'';position:absolute;left:0;top:0;
    ...
    /* Светлое — у сгиба, тёмное — на дальнем ребре. Было наоборот,
       и торец разгорался по мере ухода вглубь: у сгиба тень,
       на дальнем краю свет. Физически так не бывает, и глаз читал
       дальний край не как грань, а как торчащий светлый клин.
       На бирюзовой карточке это било сильнее, чем на розовой,
       потому что бирюзовый отсвет ярче — отсюда и ощущение, что
       карточки собраны разным кодом. Код один. */
    background:linear-gradient(90deg,#22344F 0%,#16233C 40%,#080D18 100%)}
