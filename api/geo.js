 ...
 *
 * ЗАЧЕМ. Реклама идёт на три очень разных региона, а человек приходит
 * на общую главную.
 *
 * Метку Яндекс Бизнес всё-таки ставит — utm_referer=geoadv_…, это видно
 * в отчёте Метрики за 6–9 августа, — но она говорит только «пришёл
 * с карточки». Карточка одна на три края, и региона в метке нет.
 * Поэтому способов узнать регион по-прежнему два: спросить у человека
 * или определить по его интернет-адресу.
 *
