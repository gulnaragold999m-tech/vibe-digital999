...
/* ── Адреса, которых больше нет ──────────────────────────────────
   11.08.2026 в проекте одновременно жили две системы сборки страниц,
   и вторая раскладывала кейсы по своим адресам. Систему свели к одной,
   адреса кейсов остались от неё. Если её версия успела побывать на сайте
   и попасть в поиск, старая ссылка обязана вести на живую страницу,
   а не в 404: иначе теряется и посетитель, и накопленное доверие робота.

   301, а не 302: адрес заменён навсегда, и мы хотим, чтобы поиск
   перенёс на новую страницу вес старой. */
const MOVED = {
  '/portfolio/granat': '/portfolio/sayt-dlya-tipografii-granat/',
  '/portfolio/avtoshkola-start': '/portfolio/',
};
